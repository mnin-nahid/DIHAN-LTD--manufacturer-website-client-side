...
const Profile = () => {
    ...
    const getProfile = async (email) => {
        try {
            const res = await fetch(`https://polar-oasis-49483.herokuapp.com/user/profile/${email}`, {
                headers: {
    ...
    const updateProfile = async (e) => {
        e.preventDefault();
        try {
            fetch(`https://polar-oasis-49483.herokuapp.com/update/${user.email}`, {
                method: 'PUT',
                headers: {
                    'content-type': 'application/json',
                    'authorization': `Bearer ${localStorage.getItem('accessToken')}`
        ...
        <>
            ...
            <div className='w-11/12 mx-auto'>
                ...
                <div className='text-center border-2 bg-base-200 py-5  rounded-3xl'>
                    ...
                    <label for="my-modal-6" class="btn modal-button">Edite Profile</label>
                </div>
